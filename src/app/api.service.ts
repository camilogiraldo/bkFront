...
export class ApiService {
  ...
  getMemberInfo(token: Object) {
    ...
    return this.http
      .get(this.apiUrl + "/api/memberinfo", options)
      .map((res: Response) => res.json())
      .catch((error: any) =>
        Observable.throw(console.log(error) || "Server error")
      );
  ...
  addProductToCart(id: String, token: String) {
    ...
    return this.http
      .post(this.apiUrl + "/api/addcart/" + id, body, options)
      .map((res: Response) => res.json())
      .catch((error: any) =>
        Observable.throw(console.log(error) || "Server error")
      );
  ...
  deleteProductFromCart(id: String, token: String) {
    ...
    return this.http
      .post(this.apiUrl + "/api/deletecart/" + id, body, options)
      .map((res: Response) => res.json())
      .catch((error: any) =>
        Observable.throw(console.log(error) || "Server error")
      );
  ...
  signupUser(user: Object) {
    ...
    return this.http
      .post(this.apiUrl + "/api/signup", user, options)
      .map((res: Response) => {
        return res.json();
      })
      .catch((error: any) =>
  ...
  getItemsInCart(token: String) {
    ...
    const options = new RequestOptions({ headers: headers });
    return this.http
      .get(this.apiUrl + "/api/cart/", options)
      .map((res: Response) => res.json())
      .catch((error: any) =>
        Observable.throw(console.log(error) || "Server error")
      );
  ...
  loginUser(body: Object) {
    ...
    return this.http
      .post(this.apiUrl + "/api/authenticate", bodyString, options)
      .map((res: Response) => res.json())
      .catch(res => {
        // The error callback (second parameter) is called
        return Observable.throw(res.json());
  ...
  createProduct(body: FormData) {
    ...
    return this.http
      .post(this.apiUrl + "/products/create", body, options)
      .map((res: Response) => res.json())
      .catch((error: any) =>
        Observable.throw(console.log(error) || "Server error")
      );
  ...
  updateProfileInfo(body: Object, token: Object) {
    ...
    return this.http
      .patch(this.apiUrl + "/api/update_user", body, options)
      .map((res: Response) => res.json())
      .catch(res => {
        // The error callback (second parameter) is called
        return Observable.throw(res.json());
